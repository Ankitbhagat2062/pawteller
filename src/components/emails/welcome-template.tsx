    ...
    <Tailwind>
      <Body className="bg-[#f6f7fb] font-sans">
        ...
        <Container className="mx-auto w-full max-w-150 px-4 py-8">
          <Section className="rounded-[16px] bg-white px-6 py-8 shadow-sm">
            <Img
            ...
            <Text className="text-[18px] leading-6.5 font-semibold text-[#111827]">
              Hi {userFirstname},
            </Text>

            <Text className="mt-3 text-[15px] leading-5.75 text-[#374151]">
            ...
            <Section className="mt-5 rounded-[12px] bg-[#f8fafc] px-5 py-4">
              <Text className="text-[14px] leading-5 font-semibold text-[#111827]">
                What you’ll get
              </Text>
              <Text className="mt-2 text-[14px] leading-5 text-[#374151]">
            ...
            <Section className="mt-6">
              <Text className="text-[14px] leading-5 text-[#374151]">
            ...
            <Text className="text-[13px] leading-4.75 text-[#6b7280]">
              Best,
              <br />
              The Pawteller team
            </Text>

            <Text className="mt-6 text-[11px] leading-4 text-[#9ca3af]">
