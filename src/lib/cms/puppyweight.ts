import { Dumbbell, type LucideIcon, ShieldCheck, Sparkles } from "lucide-react";
import type { FAQItem, ImageConfig, seoProps } from "@/lib/types";
...
export const HERO_CONTENT: PuppyCalculatorHeroContent = {
  ...
  description:
    "Estimate your puppy's adult weight and track their growth journey with our veterinarian-approved calculator.",
  features: [
    {
      id: "feat-accuracy",
      iconName: "PawPrint",
...
export const GROWTH_INSIGHTS_CONTENT: GrowthInsightsContent = {
  ...
  stopGrowingDesc:
    "The age at which a dog stops growing is directly related to its final adult size. Smaller breeds reach their full skeletal size much earlier than giant breeds.",
  alertNote:
    "Note: Puppies reach their full height before they reach their full weight. The growth plates in their joints usually close between 12–18 months.",
  ...
  newsletterDesc:
    "Join 15,000+ pet parents receiving monthly health milestones and growth tracking reminders.",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Our predictions are accurate within ±15% for most breeds when using data from puppies 8+ weeks old. Accuracy improves with age. Mixed-breed predictions use the average of the closest matching breeds.",
  },
  {
    question: "Does gender affect a puppy's adult weight?",
    answer:
      "Yes — males typically weigh 10–20% more than females in most breeds. Our algorithm factors in sex when available, and our ranges reflect the typical variation between male and female dogs.",
  },
  {
    question: "Why is my puppy growing faster than the chart?",
    answer:
      "Every individual puppy is different. Rapid growth isn't always good — it can put stress on developing bones and joints. If your puppy is significantly above the curve, consult your vet about caloric intake and potential nutritional adjustments.",
  },
  {
    question: "At what age do giant breeds stop growing?",
    answer:
      "Giant breeds like Great Danes and Saint Bernards may not reach their full adult size until 18–24 months. Even after skeletal growth stops, they continue to 'fill out' and gain muscle mass for several more months.",
  },
  {
    question: "Should I be worried if my puppy is small for their breed?",
    answer:
      "Not necessarily. Some puppies are naturally smaller due to genetics. However, if your puppy is consistently below 80% of the expected weight for their age, it's worth a vet visit to rule out parasites, nutritional deficiencies, or underlying health issues.",
  },
];
