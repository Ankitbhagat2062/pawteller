...
import type { ctaProps } from "@/lib/cms/aboutpage";
...
export const backlinks: BacklinkItem[] = [
  {
    ...
    description:
      "Convert dog years to human years accurately using modern veterinary aging frameworks.",
    cta: {
    ...
    className:
      "bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-amber-200/50 dark:border-amber-800/40 text-amber-900 dark:text-amber-100",
  },
  {
    title: "Puppy Weight Calculator",
    description:
      "Predict your puppy's full adult size and weight based on their current growth rate.",
    cta: {
    ...
    className:
      "bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border-emerald-200/50 dark:border-emerald-800/40 text-emerald-900 dark:text-emerald-100",
  },
  {
    title: "Dog Food Calculator",
    description:
      "Estimate daily calories and cups based on weight, life stage, and activity level.",
    cta: {
    ...
    className:
      "bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border-blue-200/50 dark:border-blue-800/40 text-blue-900 dark:text-blue-100",
  },
  {
    title: "Dog Pregnancy Calculator",
    description:
      "Track your dog's gestation timeline, key developmental milestones, and estimated due date.",
    cta: {
    ...
    className:
      "bg-gradient-to-br from-rose-500/10 to-pink-500/10 border-rose-200/50 dark:border-rose-800/40 text-rose-900 dark:text-rose-100",
  },
  {
    ...
    className:
      "bg-gradient-to-br from-purple-500/10 to-fuchsia-500/10 border-purple-200/50 dark:border-purple-800/40 text-purple-900 dark:text-purple-100",
  },
  {
    title: "Dog Growth Curve Tracker",
    description:
      "Monitor and log your puppy's week-by-week weight curve to ensure they are on a healthy path.",
    cta: {
    ...
    className:
      "bg-gradient-to-br from-cyan-500/10 to-sky-500/10 border-cyan-200/50 dark:border-cyan-800/40 text-cyan-900 dark:text-cyan-100",
  },
];
...
export const faqItems: FAQItem[] = [
  ...
  {
    question:
      "Can I use these calculators for mixed breeds or non-standard sizes?",
    answer:
  ...
  {
    question:
      "Are the feeding and calorie suggestions meant to replace my vet’s plan?",
    answer:
  ...
  {
    question:
      "When should I contact a veterinarian instead of relying on a calculator?",
    answer:
  ...
  {
    question:
      "Are there any limits on how many times I can use the calculators?",
    answer:
...
export const calculatorPageCms: calculatorPageCmsProps = {
  ...
  heroSection: {
    ...
    description:
      "Fast, mobile-friendly calculators for dog age conversion, puppy growth, feeding guidance, pregnancy timelines, and name ideas—built to help you make confident decisions between vet visits.",
    cta: [
      {
        label: "Start with Puppy Weight",
        href: "/calculators/puppy-weight",
        ariaLabel: "Start the Puppy Weight Calculator",
      },
      {
        label: "Read the guides",
        href: "/blog",
        ariaLabel: "Read Pawteller blog guides",
      },
    ],
    buttons: [
      {
        label: "Vet-informed explanations",
        icon: BadgeCheck,
        className: "text-emerald-600 dark:text-emerald-300",
      },
      {
        label: "Clean UX + SEO-ready pages",
        icon: Sparkles,
  ...
  calculatorSection: {
    ...
    description:
      "Each calculator is designed for quick input, clear results, and easy next steps.",
    cta: {
      href: "/quiz?quiz=breed-match",
      label: "Dog's IQ quiz",
      ariaLabel: "Take the quiz to find out if your dog is a secret genius",
    },
    calculators,
  },
  whyUsecalculatorSection: {
    ...
    description:
      "Pawteller calculators turn common pet-care questions into quick, structured answers—so you can plan feeding, understand growth milestones, and keep your routine consistent.",
    reasons: [
      {
        title: "Clear nutrition & planning",
        description:
          "Portions, calories, and timing you can act on immediately.",
        icon: Utensils,
        className: "text-[#e77855]",
      },
      {
        title: "Growth milestones",
        description: "Estimate puppy adult weight and see what to expect next.",
        icon: Scale,
        className: "text-emerald-300",
      },
      {
        title: "Timeline-friendly",
        description: "Pregnancy and development checkpoints for less guessing.",
        icon: CalendarDays,
        className: "text-sky-300",
      },
      {
        title: "Less wasted effort",
        description: "Faster answers to reduce uncertainty and extra searches.",
        icon: DollarSign,
    ...
    feature: {
      ...
      description:
        " Get an estimate first, then confirm details using the related articles and professional advice.",
      cta: [
        {
          label: "Browse guides",
          href: "/blog",
          ariaLabel: "View Pawteller blog guides",
        },
        {
          label: "Ask a question",
          href: "/contact",
          ariaLabel: "Contact Pawteller",
        },
      ],
    },
  },
  faqSection: {
    ...
    description:
      "Quick answers to help you choose the right tool and understand what the results mean.",
    faqItems,
  },
  backlinkblogSection: {
    ...
    cta: [
      {
        ...
        href: "/calculators/dog-age",
        ariaLabel: "Calculate your dog's age",
      },
      {
        label: "Dog Food Calculator",
        href: "/calculators/dog-food",
        ariaLabel: "Calculate your dog's food",
      },
      {
        label: "Dog Growth Calculator",
        href: "/calculators/dog-growth",
        ariaLabel: "Calculate your Dog growth",
      },
    ],
    footer: {
      title: "Read related guides",
      description:
        "Pair calculators with articles for context, tips, and next steps.",
      cta: {
        href: "/blog",
  ...
  seoblockSection: {
    ...
    description:
      "Use these tools to understand your dog’s development and care needs. Results are educational only and do not replace professional veterinary advice.",
    services: [
    ...
    footer: {
      ...
      description:
        "Subscribe for calculator updates and simple, searchable guides.",
      cta: [
        {
          label: "Read the latest",
          href: "/blog",
          ariaLabel: "Read pet care tips",
        },
        {
