...
const heroSection: AboutPageHeroSectionProps = {
  right: {
    ...
    buttons: [
      {
        label: "Calculate your dog’s age ",
      ...
      },
      {
        ...
        href: "/blog",
        ariaLabel: "Read Practical Guides",
      },
    ],
  },
  left: {
  ...
  cta: [
    {
      ...
      ariaLabel: "Calculate your Dog Food",
    },
    {
      label: "Blog guides",
      href: "/blog",
      ariaLabel:
        "Explore our Blogs about Dog health , food , growth , age and more",
    },
    {
      label: "Breed match quiz",
      href: "/quiz?quiz=breed-match",
      ariaLabel: "Quiz to find your perfect breed match",
    },
  ],
};
...
const bottomCtaBand: AboutPageBottomCtaBandProps = {
  ...
  cta: {
    ...
    ariaLabel: "Calculate the growth of your dog",
  },
};
...
export const AboutPageCms: AboutPageCmsProps = {
  seo: {
    title:
      "About Pawteller | Fast Dog Growth Calculators & Vet-Informed Guides",
    description:
