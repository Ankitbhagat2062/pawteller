...
export const blogPosts: BlogPost[] = [
    ...
    content: [
      {
        ...
        description: "Newborn puppies are blind, deaf, and entirely dependent on their mother. They spend 90% of their time sleeping and the other 10% nursing. By week 2, eyes start to open.",
        time: "Week 1-2"
      },
      {
        title: "First steps",
        description: "Tiny legs start working. Puppies begin to walk, play, and respond to sound. Solid food is introduced around 4 weeks.",
        time: "Week 3-4"
      },
      {
        title: "The socialization window",
        description: "This is the most important developmental window of your puppy’s life. Positive exposure to people, sounds, and other animals shapes who they’ll become.",
        time: "Week 5-8"
      },
      {
        time: "Month 3–6",
        title: "The growth sprint",
        description: "Puppies hit their biggest growth phase. Large breeds may gain 2–4 lbs per week. Use our Puppy Weight Calculator to track their curve."
      },
      {
        time: "Month 6–12",
        title: "Adolescent dog",
        description: " Growth slows. Sexual maturity arrives. Training matters now more than ever — puppies test boundaries like teenagers."
      },
      {
        time: "Year 1–2 ",
        title: " Adult dog",
        description: "Most small/medium breeds are fully grown by 12 months. Large/giant breeds may grow until 18–24 months."
      }
    ],
    category: "Growth",
    date: "Updated Weekly",
  ...
  },
  {
    ...
    description:"Why the “multiply by 7” rule is wrong, and what to use instead.",
    ...
    content: [
      {
        ...
        description: "The popular “1 dog year = 7 human years” rule comes from rough lifespan averages — not biology. Dogs don’t age linearly."
      },
      {
        title: "The real formula",
        description: "Year 1 ≈ 15 human years. Year 2 adds 9. After that, small breeds age ~4 years/year, medium ~5, large ~6, giant ~7. Our Dog Age Calculator uses this veterinary framework."
      },
      {
        title: "Why bigger dogs age faster",
        description: "Researchers think it’s tied to faster cell division and shorter telomere length in large breeds. A Great Dane at 6 is biologically similar to a Chihuahua at 10."
      },
      {
        title: "When to call your dog “senior”",
        description: "Small breeds: 10–11. Medium: 8–9. Large: 7–8. Giant: 5–6. Senior care — joint support, slower food, more vet visits — should start then."
      },
    ],
  },
  {
    title: "Choosing the right breed: 7 questions to ask first",
    description:"Before falling for that adorable face, run through this checklist.",
    ...
    content: [
      {
        ...
        description: "A Border Collie needs 2+ hours daily. A Bulldog is happy with 30 minutes. Mismatch = unhappy dog + frustrated human."
      },
      {
        title: "2. How much space do you have?",
        description: "Apartments suit small/medium low-energy breeds. Big yards suit working breeds."
      },
      {
        title: "3. Allergy or shedding concerns?",
        description: "Poodles, Bichons, and Schnauzers shed minimally. Huskies and Golden Retrievers shed constantly."
      },
      {
        title: "4. Family situation?",
        description: "Some breeds adore kids (Labs, Goldens, Beagles). Others prefer adult-only homes.",
      },
      {
        title: "5. Experience level?",
        description: "First-time owner? Skip Akitas and Cane Corsos. Start with a Cavalier King Charles or Lab.",
      },
      {
        title: "6. Time budget?",
        description: "Long-coated breeds need weekly grooming. Working breeds need daily mental stimulation.",
      },
      {
        title: "7. Lifespan expectations?",
        description: "Small breeds often live 14–16 years. Giants average 7–9. Plan emotionally and financially.",
      }
    ],
  },
  {
    ...
    content: [
      {
        ...
        description: "Resting Energy Requirement = 70 × (weight in kg)^0.75. That’s the baseline calories your dog burns just existing."
      },
      {
        title: "Then multiply by life-stage factor",
        description: "Puppies under 4 months: RER × 3. Puppies 4–9 months: RER × 2.5. Puppies 9–12 months: RER × 2. Active adults: RER × 1.6. Couch potatoes: RER × 1.4."
      },
      {
        title: "Convert to cups",
        description: "Most dry kibble is around 350 kcal/cup. Always check your bag — premium foods can be 400+. Our Dog Food Calculator handles this for you."
      },
      {
        title: "How many meals?",
        description: "Puppies under 4 months: 4 small meals. Older puppies: 3 meals. Adults: 2 meals. Splitting reduces tummy upset and stabilizes energy.",
      },
    ],
  },
];
