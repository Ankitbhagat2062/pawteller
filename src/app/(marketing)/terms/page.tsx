            ...
            <div className="lg:col-span-8">
              <header className="border-b border-zinc-100 dark:border-zinc-800/50 pb-6">
                ...
                <p className="mt-4 text-base leading-7 text-slate-600 dark:text-slate-300 max-w-2xl">
                  ...
                  website are provided, outlining user guidelines and essential
                  medical safety data disclaimers.
                </p>
              ...
              <div className="mt-8 space-y-10 focus:outline-none">
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    ...
                    and to comply with all applicable laws and rules. If you do
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    ...
                    educational materials, is for general informational purposes
                    only. It is not intended to diagnose, treat, cure, or
                ...
                <section
                  id="no-vet-advice"
                  aria-labelledby="no-vet-advice-title"
                  className="scroll-mt-28"
                >
                  <h2
                    id="no-vet-advice-title"
                    className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-slate-50"
                  >
                    No Veterinary Advice
                  </h2>
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    pawteller does not provide veterinary advice. Nothing on the
                    website creates a doctor–patient relationship between you
                    and pawteller, its creators, or any third parties.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    We may modify, suspend, or discontinue any part of pawteller
                    at any time. We do not guarantee that the website will be
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    ...
                    intellectual property are protected by applicable laws. You
                    may not copy, distribute, modify, or create derivative works
                    from our materials without permission.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    If you submit content or feedback to pawteller, you grant us
                    a worldwide, non-exclusive, royalty-free license to use,
                    reproduce, and distribute that material as permitted by
                    applicable law.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    pawteller may link to third-party websites for convenience.
                    We do not control those sites and are not responsible for
                    their content, policies, or availability.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-slate-300">
                    ...
                    affiliates are not liable for damages arising from your use
                    of the website, including errors, omissions, or reliance on
                    content.
                  </p>
                </section>
              ...
              <section
                className="mt-12 border-t border-zinc-100 dark:border-zinc-800/50 pt-8"
