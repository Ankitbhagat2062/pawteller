              ...
              <div className="lg:col-span-7">
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                  <Link
                    ...
                    aria-label="Calculate your dog’s age"
                  ...
                  <Link
                    href="/blog"
                    aria-label="Read practical guides"
              ...
              <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
                <div className="lg:col-span-6">
                  ...
                  <p className="mt-3 text-base leading-7 text-slate-600 dark:text-slate-300">
                    pawteller exists to help you go from question → numbers →
                    next steps, quickly. Our calculators are designed to be
                ...
                <div className="lg:col-span-5">
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <Link
                      ...
                      aria-label="Quiz to find your perfect breed match"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
                    pawteller tools and guides are for educational purposes.
                    They can’t diagnose medical conditions and aren’t a
                    replacement for veterinary care. If you’re worried about
                    your dog’s health, contact a qualified veterinarian.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-12 md:items-center">
              ...
              <div className="md:col-span-4 md:text-right">
                <Link
                  ...
                  aria-label="Start with a calculator"
                  className="inline-flex h-12 items-center justify-center rounded-full bg-emerald-600 px-6 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600"
                >
