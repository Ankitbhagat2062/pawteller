          ...
          <section className="mt-4 rounded-[28px] overflow-hidden bg-[#f3ded3] px-6 py-14 sm:px-8 sm:py-18 lg:px-12 lg:py-20 dark:bg-emerald-500/10">
            <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-6">
                ...
                <h1
                  className="mt-7 font-[Georgia,serif] text-4xl font-black leading-[1.02] tracking-normal
               text-[#2a1b15] dark:text-[#e6bdae] sm:text-[3.9rem]"
                >
                  {heroSection.title && `${heroSection.title}`}
                  <span className="block italic text-[#d36c4a]">
                    milestone.
                  </span>
                </h1>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                  {heroSection.cta?.map((cta) => (
                    <Link
                      key={cta.label}
                      href={cta.href || "/calculators/puppy-weight"}
                      aria-label={
                        cta.ariaLabel ||
                        "Start using the Puppy Weight Calculator"
                      }
                ...
                <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-[#6b5d56] dark:text-zinc-300">
                  {heroSection.buttons?.map((btn) => (
                    ...
                    >
                      {btn.icon && (
                        <btn.icon className={`h-4 w-4 ${btn.className}`} />
                      )}
                      {btn.label}
                    </p>
                  ))}
          ...
          <section className="mt-10">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <Link
                  href={
                    calculatorSection.cta.href
                      ? calculatorSection.cta.href
                      : "/quiz?quiz=breed-match"
                  }
                  aria-label={
                    calculatorSection.cta.ariaLabel
                      ? calculatorSection.cta.ariaLabel
                      : "Take the quiz to find out if your dog is a secret genius"
                  }
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:auto-rows-[240px]">
              {calculatorSection.calculators?.map((calc) => {
            ...
            <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
              <div className="lg:col-span-7">
                ...
                <ul className="mt-7 grid gap-3 sm:grid-cols-2">
                  {whyUsecalculatorSection.reasons?.map((reason) => (
                    <li
                      key={reason.title}
                    ...
                    >
                      {reason.icon && (
                        <reason.icon
                          aria-hidden="true"
                          className={`mt-0.5 h-5 w-5 ${reason.className}`}
                        />
                      )}
                      <div>
                ...
                {whyUsecalculatorSection.feature && (
                  <div className="min-h-62.5 rounded-[24px] bg-white/10 p-6 ring-1 ring-white/10">
                    <p className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-[0.2em]">
                      <Sparkles className="h-4 w-4" aria-hidden="true" />
                      {whyUsecalculatorSection.feature.banner
                        ? whyUsecalculatorSection.feature.banner
                        : `Featured workflow`}
                    </p>
                    <h3 className="mt-4 font-[Georgia,serif] text-2xl font-bold">
                      {whyUsecalculatorSection.feature.title
                        ? whyUsecalculatorSection.feature.title
                    ...
                    <div className="mt-6 flex flex-col gap-3">
                      {whyUsecalculatorSection.feature.cta?.map((cta) => (
                        <Link
                          key={cta.label}
                          href={cta.href}
            ...
            <div className="lg:col-span-5 w-full">
              <div className="min-h-62.5 rounded-[24px] w-full bg-white/70 p-6 ring-1 ring-border dark:bg-zinc-950/30">
                ...
                <h3 className="mt-3 font-[Georgia,serif] text-2xl font-bold text-slate-900 dark:text-slate-50">
                  {backlinkblogSection.description
                    ? backlinkblogSection.description
                    : `Keep exploring`}
                </h3>

                <div className="mt-5 space-y-3">
                  {backlinkblogSection.cta?.map((cta) => (
                    <Link
                      key={cta.label}
                      href={cta.href}
                      aria-label={cta.ariaLabel}
                ...
                {backlinkblogSection.footer && (
                  <div className="mt-6 rounded-2xl bg-emerald-500/10 p-4 ring-1 ring-emerald-500/20">
                    <p className="inline-flex items-center gap-2 text-sm font-extrabold text-emerald-800 dark:text-emerald-200">
                      <BookOpen className="h-4 w-4" aria-hidden="true" />
                      {backlinkblogSection.footer.title
                        ? backlinkblogSection.footer.title
                        : `Read related guides`}
                    </p>
                    <p className="mt-2 text-xs leading-5 text-slate-600 dark:text-slate-300">
                      {backlinkblogSection.footer.description
                        ? backlinkblogSection.footer.description
                    ...
                    <div className="mt-3">
                      ...
                      >
                        {backlinkblogSection.footer.cta && (
                          <Link
                            href={
                              backlinkblogSection.footer.cta.href || "/blog"
                            }
                            aria-label={
                          ...
                          >
                            {backlinkblogSection.footer.cta.label
                              ? backlinkblogSection.footer.cta.label
                              : `Browse the blog`}
                          </Link>
                        )}
              ...
              <div className="grid gap-8 md:grid-cols-12 md:items-start">
                <div className="md:col-span-7">
                  <h2 className="font-[Georgia,serif] text-2xl font-bold text-slate-900 dark:text-slate-50">
                    {seoblockSection.title
                      ? seoblockSection.title
                      : `SEO-friendly calculator hub`}
                  </h2>
                  <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">
                    {seoblockSection.description
                      ? seoblockSection.description
                  ...
                  <ul className="mt-4 grid gap-2 sm:grid-cols-2">
                    {seoblockSection.services?.map(({ title }) => (
                      <li
                        key={title}
                        className="inline-flex items-center gap-2 text-sm font-bold text-slate-700 dark:text-slate-200"
                      >
                        <span
                  ...
                  {seoblockSection.footer && (
                    <div className="min-h-62.5 rounded-2xl bg-muted/50 p-5 ring-1 ring-border dark:bg-zinc-900/40">
                      ...
                      <div className="mt-5 flex flex-col gap-3">
                        {seoblockSection.footer.cta?.map((cta) => (
                          <Link
                            key={cta.label}
                            href={cta.href}
